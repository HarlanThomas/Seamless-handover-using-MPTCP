...
for i  = 1 :4
    ...
    switch i 
        case 1      % 40W   =  53dBm
                RSS_UMTS  = 53 - 127.5    -35.2 * log10((distance + 500 )/1000) ;
        case 2      % 
                RSS_LTE  = 43 - 127.5  - 35.2 * log10((distance + 300  )  /1000);
        case 3
                RSS_WLAN  = 23 - 32.5 -  20 * log10(2.4e3)  -20 * log10((distance + 200 )/1000)  - normrnd(20,10, [size(distance,1)  size(distance,2)]) ; 
        case 4
                RSS_WiMAX  = 30 - 127.5   - 35.2 * log10((distance + 300 + 100 *  rand(size(distance)) )/1000);
    end
